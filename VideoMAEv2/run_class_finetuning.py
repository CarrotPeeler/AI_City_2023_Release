...
def get_args():
    ...
    parser.add_argument('--img_diff_json_path', default=None, type=str)
    parser.add_argument('--sample_mode', default="normal", type=str)
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            'HMDB51', 'Diving48', 'Kinetics-710', 'MIT', 'AI-City-Track-3'
        ],
        type=str,
        help='dataset')
    parser.add_argument(
